                ...
                with st.container():
                    st.markdown("""
                        ...
                        .css-m7esqn.epcbefy1 {
                            ...
                            width: 80%;
                            border-radius: 2rem;
                            box-shadow: 0px 2px 16px rgba(0, 0, 0, 0.15), 0px 8px 36px rgba(0, 0, 0, 0.08);
                            border: 0px;
                            margin-left: 60px;
                            align-items: center;
                    ...
                    with st.form('Login'):  
                        ...
                        st.markdown(f"<h2 style='text-align: center; font-size:32px; color:#darkslategray; font-weight:600;'>Iniciar Sessão com Azure AD</h2>",
                        unsafe_allow_html=True)
                        st.markdown("""<hr style="height:10px;border:none;color:transparent;background-color:transparent;" /> """, unsafe_allow_html=True)
                        fc1,fc2,fc3 = st.columns([1,3,1])
                        with fc2:
                            #Login_mail = st.text_input('Email AD', placeholder='Email A3Data', label_visibility="collapsed", key='LoginMail')
                            # Define uma classe CSS personalizada
                            st.markdown("""
                            <style>
                            .email-input label {
                                display: none;
                            ...
                            # Cria um st.text_input() para o email e envolve com a div com a classe CSS personalizada
                            Login_mail = st.markdown("""
                            <div class="email-input">
                                <label for="email">Email AD:</label>
                                <input type="text" id="email" name="email" placeholder="Digite seu email A3Data">

                            </div>
                            """, unsafe_allow_html=True)

                            Login_pwd = st.markdown("""
                            <div class="pwd-input">
                                <label for="pwd">Senha AD:</label>
